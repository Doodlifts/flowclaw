...
transaction(
    ...
    prepare(signer: auth(Storage) &Account) {
        ...
        ) ?? panic("AgentStack not found. Run setup_full_account first.")
        ...
        // Borrow the active agent from the AgentCollection (multi-agent support).
        // Falls back to legacy single-agent path for pre-collection accounts.
        ...
        if collection != nil {
            ...
            if defaultId != nil {
                ...
                // No default set — use first agent in collection
        ...
        // Legacy fallback: single-agent path
        if agent == nil {
